...
export default function KuisPage() {
  ...
  const questions = [
    // === E vs I (8 soal) ===
    {
      ...
      options: [
        {
          text: "Main rame-rame sama banyak teman",
          emoji: "🏃",
          traits: { E: 1 },
        },
        {
          text: "Main sama satu atau dua teman dekat saja",
          emoji: "👫",
          traits: { I: 1 },
        },
      ],
    },
    {
      ...
      options: [
        {
          text: "Ngundang banyak teman buat kumpul",
          emoji: "🎉",
          traits: { E: 1 },
        },
        {
          text: "Rayain sederhana sama keluarga",
          emoji: "🎂",
          traits: { I: 1 },
        },
      ],
    },
    {
      ...
      options: [
        {
          text: "Main dulu sama teman di sekitar rumah",
          emoji: "⚽",
          traits: { E: 1 },
        },
        {
          text: "Langsung istirahat atau main sendiri di rumah",
          emoji: "🏠",
          traits: { I: 1 },
        },
      ],
    },
    {
      ...
      options: [
        {
          text: "Diskusi bareng-bareng sama teman",
          emoji: "👥",
          traits: { E: 1 },
        },
    ...
    {
      question:
        "Kalau ada acara di sekolah (lomba, pentas, atau upacara besar)...",
      options: [
        {
          text: "Aku senang ikut kumpul dan ngobrol",
          emoji: "🗣️",
          traits: { E: 1 },
        },
        {
          text: "Aku lebih nyaman bareng teman dekat saja",
          emoji: "🙂",
          traits: { I: 1 },
        },
      ],
    },
    {
      ...
      options: [
        ...
        {
          text: "Lebih sering dengerin dan sedikit bicara",
          emoji: "🤫",
          traits: { I: 1 },
        },
      ],
    },
    {
      ...
      options: [
        {
          text: "Ikut ramai-ramai dan kenalan sama banyak teman",
          emoji: "🎈",
          traits: { E: 1 },
        },
        {
          text: "Ikut lomba bareng teman yang sudah dekat",
          emoji: "🪁",
          traits: { I: 1 },
        },
      ],
    },
    {
      ...
      options: [
        ...
        {
          text: "Capek dan ingin sendirian dulu",
          emoji: "😌",
          traits: { I: 1 },
        },
      ],
    ...
    // === S vs N (8 soal) ===
    {
      ...
      options: [
        {
          text: "Ada contoh yang bisa dilihat langsung",
          emoji: "👀",
          traits: { S: 1 },
        },
        {
          text: "Diceritain dulu maksud dari pelajarannya",
          emoji: "🌈",
          traits: { N: 1 },
        },
      ],
    ...
    },
    {
      ...
      options: [
        {
          text: "Menyusun pelan-pelan sesuai contoh",
          emoji: "📋",
          traits: { S: 1 },
        },
        {
          text: "Bikin bentuk sesuai ide sendiri",
          emoji: "✨",
          traits: { N: 1 },
        },
      ],
    ...
    },
    {
      ...
      options: [
        {
          text: "Hal-hal yang sering kamu lihat",
          emoji: "🌾",
          traits: { S: 1 },
        },
        {
          text: "Hal-hal dari bayangan di kepala",
          emoji: "🌟",
          traits: { N: 1 },
        },
      ],
    },
    {
      ...
      options: [
        {
          text: "Suka mengingat semua nama-nama tokoh di ceritanya",
          emoji: "📝",
          traits: { S: 1 },
        },
        {
          text: "Ingat dan paham keseluruhan ceritanya saja",
          emoji: "💡",
          traits: { N: 1 },
        },
      ],
    ...
    },
    {
      ...
      options: [
        {
          text: "Langsung pasang kepingan yang cocok satu-satu",
          emoji: "🧩",
          traits: { S: 1 },
        },
        {
          text: "Membayangkan dulu gambar apa yang akan terbentuk",
          emoji: "🖼️",
          traits: { N: 1 },
        },
      ],
    ...
    {
      question:
        "Kalau ada teman yang sedang sedih atau menangis, kamu biasanya...",
      options: [
        {
          text: "Tanya kenapanya dan coba bantu cari jalan keluar",
          emoji: "🤔",
          traits: { T: 1 },
        },
        {
          text: "Menemani dan menghiburnya dulu",
          emoji: "🤗",
          traits: { F: 1 },
        },
      ],
    },
    {
      ...
      options: [
        {
          text: "Jawabannya jelas dan masuk akal",
          emoji: "✅",
          traits: { T: 1 },
        },
        {
          text: "Semua teman bisa bekerja dengan nyaman",
          emoji: "😊",
          traits: { F: 1 },
        },
      ],
    },
    {
      ...
      options: [
        {
          text: "Permainannya rapi dan aturannya jelas",
          emoji: "📏",
          traits: { T: 1 },
        },
        {
          text: "Semua teman bisa ikut dan senang",
          emoji: "🎮",
          traits: { F: 1 },
        },
      ],
    },
    {
      ...
      options: [
        {
          text: "Menjelaskan apa yang seharusnya dilakukan",
          emoji: "📘",
          traits: { T: 1 },
        },
        {
          text: "Menegur dengan kata-kata yang lembut",
          emoji: "💝",
          traits: { F: 1 },
        },
      ],
    },
    {
      ...
      options: [
        {
          text: "Memikirkan mana yang paling masuk akal",
          emoji: "⚖️",
          traits: { T: 1 },
        },
        {
          text: "Memikirkan agar tidak ada yang tersinggung",
          emoji: "❤️",
          traits: { F: 1 },
        },
      ],
    },
    {
      ...
      options: [
        {
          text: "Berpikir kenapa cerita itu bisa terjadi",
          emoji: "🧠",
          traits: { T: 1 },
        },
    ...
    },
    {
      ...
      options: [
        {
          text: "Bisa menyelesaikan masalah dengan baik",
          emoji: "💪",
          traits: { T: 1 },
        },
        {
          text: "Bisa membantu dan membuat orang lain senang",
          emoji: "🌟",
          traits: { F: 1 },
        },
      ],
    },
    {
      ...
      options: [
        {
          text: "Mencari tahu masalahnya supaya selesai",
          emoji: "🔍",
          traits: { T: 1 },
        },
        {
          text: "Menenangkan dan mendamaikan mereka",
          emoji: "☮️",
          traits: { F: 1 },
        },
      ],
    ...
    // === J vs P (8 soal) ===
    {
      ...
      options: [
        ...
        {
          text: "Tidak selalu rapi, tapi aku tahu barangku di mana",
          emoji: "🎨",
          traits: { P: 1 },
        },
      ],
    },
    {
      ...
      options: [
        {
          text: "Langsung kerjakan saat pulang sekolah",
          emoji: "✍️",
          traits: { J: 1 },
        },
        {
          text: "Mengerjakannya setelah tidur siang atau main",
          emoji: "⏰",
          traits: { P: 1 },
        },
      ],
    },
    {
      ...
      options: [
        ...
        {
          text: "Melihat situasi dulu baru menentukan",
          emoji: "🌊",
          traits: { P: 1 },
        },
      ],
    },
    {
      ...
      options: [
        ...
        {
          text: "Main dulu, aturannya sambil jalan",
          emoji: "🎲",
          traits: { P: 1 },
        },
      ],
    },
    {
      ...
      options: [
        {
          text: "Ada aturan dan urutan bermainnya",
          emoji: "🗓️",
          traits: { J: 1 },
        },
        {
          text: "Tidak banyak aturan, yang penting asik",
          emoji: "🎭",
          traits: { P: 1 },
        },
      ],
    },
    {
      ...
      options: [
        {
          text: "Perlu waktu sebentar buat menyesuaikan",
          emoji: "🙂",
          traits: { J: 1 },
        },
    ...
    },
    {
      ...
      options: [
        {
          text: "Menyelesaikannya sampai selesai",
          emoji: "✔️",
          traits: { J: 1 },
        },
    ...
    },
    {
      ...
      options: [
        {
          text: "Buku dan alat tulis tertata rapi",
          emoji: "🎒",
          traits: { J: 1 },
        },
        {
          text: "Isinya kadang rapi, kadang campur",
          emoji: "👜",
          traits: { P: 1 },
        },
      ],
  ...
  const activities = [
    ...
    },
    {
      ...
      rolemodel:
        "Eliot Ness, Alexander the Great, Jenderal Hoegeng Iman Santoso",
      traits: ["I", "S", "T", "J"],
      subjects: ["PJOK", "PPKn"],
      icon: "👮",
    },
  ...
  const handleAnswer = (answerIndex: number) => {
    ...
    if (selectedOption.traits) {
      const traitsObj = selectedOption.traits as unknown as Record<
        string,
        number
      >;
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      const rawExplanation =
        finalExplanation ||
        `Menjadi ${cleanedCitaCita} adalah profesi yang sangat menarik! Untuk mencapai cita-citamu, kamu perlu belajar dengan rajin di sekolah dan selalu semangat.`;
      ...
      const addFooter = (pageNum: number, totalPages: number) => {
        ...
        pdf.text(`Dibuat pada: ${date}`, pageWidth / 2, footerY + 5, {
          align: "center",
        });
      ...
      const citaCitaLines = pdf.splitTextToSize(
        citaCitaText,
        contentWidth - 10,
      );
      ...
      // Download PDF
      const sanitizedName = displayNama
      ...
      setTimeout(() => {
        alert(
          `Terjadi kesalahan saat membuat PDF: ${errorMessage}\n\nSilakan coba lagi atau refresh halaman.`,
        );
        setPdfError("");
      }, 100);
    } finally {
  ...
  if (showResult) {
    ...
    const baseUrl =
      process.env.NEXT_PUBLIC_BASE_URL || "https://educorner.my.id";
    ...
    const quizStructuredData = {
      ...
      description:
        "Ikuti kuis interaktif untuk menemukan profesi yang cocok dengan kepribadian dan minatmu. Dapatkan rekomendasi cita-cita berdasarkan jawabanmu.",
      url: `${baseUrl}/kuis`,
      ...
      <>
        ...
        <div className="min-h-screen bg-gradient-to-br from-[#FFE8EC] via-[#FFF5F7] to-[#FFE8EC] flex flex-col relative overflow-hidden">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div
              className="absolute bottom-10 right-10 w-64 h-64 bg-[#FFD4E5] rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse-slow"
              style={{ animationDelay: "1s" }}
            ></div>

            {/* Floating decorations */}
            <div
              className="absolute top-20 right-20 text-6xl opacity-10 animate-pulse"
            ...
            <div
              className="absolute bottom-32 left-16 text-5xl opacity-10 animate-bounce"
          ...
          <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-custom border-b border-[#FCE7F3]/50 px-4 sm:px-6 md:px-10 lg:px-16 py-2 md:py-3 shadow-sm">
            <div className="flex items-center gap-2 sm:gap-3">
              <div
                ...
                style={{
                  boxShadow:
                    "0px 4px 30px -4px rgba(255, 77, 109, 0.2), 0px 0px 20px rgba(255, 77, 109, 0.1)",
                  background:
                    "linear-gradient(135deg, rgba(255, 255, 255, 0.9) 0%, rgba(255, 240, 243, 0.9) 100%)",
                }}
              >
                <Image
                  src={logoWebp}
          ...
          <div className="flex-1 flex items-center justify-center px-4 py-8">
            <div className="max-w-2xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden animate-scale-in relative z-10">
              ...
              <div className="bg-gradient-to-br from-[#FFE8EC] to-[#FFF0F3] px-8 py-10 text-center relative">
                {/* Decorative elements */}
                <div
                  className="absolute top-4 right-4 text-4xl opacity-30 animate-pulse"
                  suppressHydrationWarning
                >
                  🎨
                </div>
                <div
                  className="absolute bottom-4 left-4 text-3xl opacity-30 animate-bounce"
                  style={{ animationDuration: "3s" }}
                  suppressHydrationWarning
                >
                  ⭐
                ...
                <div className="space-y-3 animate-fade-in">
                  ...
                  {mbtiCode && (
                    <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 mb-4 border-2 border-[#FF4D6D]">
                      ...
                      <p className="text-3xl font-bold text-[#FF4D6D]">
                        {mbtiCode}
                      </p>
                      <p className="text-xs text-[#999999] mt-2">
                        Kamu adalah anak yang unik! Kombinasi sifatmu
                        menunjukkan potensi hebat.
                      </p>
                    </div>
                  )}
                ...
                {topCareers.length > 0 ? (
                  topCareers.map((item, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="bg-gradient-to-br from-white to-[#FFF8F9] rounded-2xl p-6 border-2 border-gray-100 shadow-lg hover:shadow-xl transition-all"
                      >
                        {/* Header Card */}
                        <div className="bg-gradient-to-r from-[#FFE4E9] to-[#FFD4E5] rounded-xl p-4 mb-4 flex items-center justify-between">
                          ...
                          <div className="bg-white rounded-full px-4 py-2 border-2 border-[#FF4D6D]">
                            <p className="text-sm font-bold text-[#FF4D6D]">
                        ...
                        <div className="bg-gradient-to-r from-[#E1F5FE] to-[#B3E5FC] rounded-xl p-3">
                          <p className="text-sm font-semibold text-[#0277BD] mb-1">
                            📚 Pelajaran Favorit:
                          </p>
                          <p className="text-sm font-bold text-[#01579B]">
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#FFF0F3] via-[#FFF5F7] to-[#FFF0F3] relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div
            className="absolute top-40 right-10 w-72 h-72 bg-[#DCFCE7] rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse-slow"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute -bottom-32 left-1/2 w-96 h-96 bg-[#FFE4E9] rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse-slow"
            style={{ animationDelay: "2s" }}
          ></div>

          {/* Fun Floating Shapes */}
          <div
            className="absolute top-[15%] right-[20%] text-4xl opacity-20 animate-pulse"
          ...
          <div
            className="absolute bottom-[20%] right-[15%] text-3xl opacity-20 animate-pulse"
          ...
          <div
            className="absolute top-[45%] left-[8%] text-3xl opacity-20 animate-bounce"
          ...
          <div
            className="absolute bottom-[25%] left-[12%] text-4xl opacity-20 animate-pulse"
            style={{ animationDuration: "3s" }}
            suppressHydrationWarning
          >
            ✏️
        ...
        <main className="container mx-auto px-4 sm:px-6 md:px-8 py-8 md:py-12 max-w-4xl relative z-10">
          ...
          {isTransitioning && (
            <div className="fixed inset-0 bg-white/80 backdrop-blur-sm z-40 flex items-center justify-center">
              <div className="text-center">
                ...
                <p
                  className="text-[#FF4D6D] font-semibold text-lg"
                  style={{ fontFamily: "Inter, sans-serif" }}
                >
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-center mb-6">
                <div className="bg-gradient-to-r from-[#FF4D6D]/10 to-[#FF6B8A]/10 px-6 py-2 rounded-full border border-[#FF4D6D]/20">
                  <span
                    className="text-sm font-semibold text-[#FF4D6D]"
                    style={{ fontFamily: "Inter, sans-serif" }}
                  >
              ...
              <h2
                className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#2D2D2D] mb-12 text-center leading-tight"
                style={{ fontFamily: "Inter, sans-serif" }}
              >
                {question.question}
              </h2>
                ...
                {question.options.map((option: any, index: number) => (
                  <button
                    ...
                    style={{
                      ...
                      animation:
                        optionsVisible && !isTransitioning
                          ? index === 0
                  ...
                  >
                    ...
                    {/* Badge Label */}
                    <div
                      className="absolute top-4 right-4 w-8 h-8 bg-gradient-to-br from-[#FFE4E9] to-[#FFB6C1] group-hover:from-[#FF4D6D] group-hover:to-[#FF6B8A] rounded-full flex items-center justify-center font-bold text-sm text-[#FF4D6D] group-hover:text-white transition-all duration-300 shadow-md group-hover:shadow-lg z-10"
                      style={{ fontFamily: "Inter, sans-serif" }}
                    >
                    ...
                    <div
                      ...
                      style={{
                        ...
                        animation:
                          optionsVisible && !isTransitioning
                            ? "scaleInBounce 0.8s cubic-bezier(0.34, 1.56, 0.64, 1) forwards"
                            : "none",
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-8 animate-fade-in">
            <div className="flex items-center gap-3 bg-gradient-to-r from-[#FFF0F3] to-[#FFE4E9] px-6 py-3 rounded-full shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105">
              ...
              <span
                className="text-sm font-bold text-[#FF4D6D] uppercase tracking-wide"
                style={{ fontFamily: "Inter, sans-serif" }}
              >
                Kamu Pasti Bisa
              </span>
            ...
            <div className="flex items-center gap-3 bg-gradient-to-r from-[#F0FDF4] to-[#DCFCE7] px-6 py-3 rounded-full shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105">
              <div
                className="w-10 h-10 rounded-full flex items-center justify-center bg-gradient-to-br from-[#A7C957] to-[#6A994E] shadow-lg animate-bounce-slow"
              ...
              <span
                className="text-sm font-bold text-[#6A994E] uppercase tracking-wide"
                style={{ fontFamily: "Inter, sans-serif" }}
              >
                Raih Mimpimu
              </span>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FFF0F3] via-[#FFF5F7] to-[#FFF0F3] relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        {/* Fun Floating Shapes */}
        <div
          className="absolute top-[10%] left-[8%] text-5xl opacity-30 animate-pulse"
          style={{ animationDuration: "2s" }}
          suppressHydrationWarning
        >
          ⭐
        ...
        <div
          className="absolute top-[15%] right-[12%] text-5xl opacity-30 animate-bounce"
        ...
        <div
          className="absolute bottom-[20%] left-[10%] text-5xl opacity-30 animate-pulse"
          style={{ animationDuration: "3.5s", animationDelay: "1s" }}
          suppressHydrationWarning
        >
          🚙
        ...
        <div
          className="absolute bottom-[15%] right-[15%] text-5xl opacity-30 animate-bounce"
          style={{ animationDuration: "3s" }}
          suppressHydrationWarning
        >
          ✏️
      ...
      <main className="container mx-auto px-4 sm:px-6 md:px-8 py-12 md:py-16 max-w-3xl relative z-10">
        <div className="text-center mb-10 animate-fade-in">
          <h2
            className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#2D2D2D] mb-3"
            style={{ fontFamily: "Inter, sans-serif" }}
          >
            Siap Temukan{" "}
            <span className="bg-gradient-to-r from-[#FF4D6D] to-[#FF6B8A] bg-clip-text text-transparent">
              Cita-Citamu?
            </span>
          </h2>
          <p
            className="text-base md:text-lg text-[#666666] font-medium flex items-center justify-center gap-2"
            style={{ fontFamily: "Inter, sans-serif" }}
          >
            <span>
              Pilih karakter kerenmu dan ketik namamu untuk menyapa mereka!
            </span>
            <span className="text-2xl" suppressHydrationWarning>
              ✋
            </span>
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 md:p-10 animate-scale-in">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              <h3
                className="text-center text-base md:text-lg font-bold text-[#2D2D2D] mb-6"
                style={{ fontFamily: "Inter, sans-serif" }}
              >
                Pilih Karakter Kamu
              </h3>
              <div className="grid grid-cols-3 sm:grid-cols-5 gap-4 justify-items-center">
                {characters.map((char, index) => (
                  ...
                  >
                    <div
                      className={`w-16 h-16 md:w-20 md:h-20 rounded-full bg-gradient-to-br ${char.bgColor} flex items-center justify-center text-3xl md:text-4xl shadow-md transition-all ${
                        kelas === ((index % 6) + 1).toString()
                          ? `ring-4 ${char.ringColor} shadow-lg`
                          : ""
                      }`}
                    >
            ...
            <div>
              <h3
                className="text-center text-base md:text-lg font-bold text-[#2D2D2D] mb-4"
                style={{ fontFamily: "Inter, sans-serif" }}
              >
              ...
              <p
                className="text-xs md:text-sm text-[#999999] text-center mt-3 italic"
                style={{ fontFamily: "Inter, sans-serif" }}
              >
